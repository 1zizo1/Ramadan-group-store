...
function c(e, u, c, i) {
        ...
        var r = function(r) {
            ...
            if (b || L) {
                ...
                if (d.current = [].slice.call(arguments), m.current = l, a.current = i, O && !x.current && (x.current = function() {
                    var r;
                    "hidden" === (null == (r = ("TURBOPACK ident replacement", globalThis).document) ? void 0 : r.visibilityState) && E.current.flush();
                }, null == (e = ("TURBOPACK ident replacement", globalThis).document) || null == e.addEventListener || e.addEventListener("visibilitychange", x.current)), f) {
    ...
    return E.current = D, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(function() {
        return h.current = !0, function() {
            var r;
            O && E.current.flush(), x.current && (null == (r = ("TURBOPACK ident replacement", globalThis).document) || null == r.removeEventListener || r.removeEventListener("visibilitychange", x.current), x.current = null), h.current = !1;
        };
    }, [
        O
    ]), D;
...
//# sourceMappingURL=node_modules_e6b36120._.js.map