...
function DialogFooter(param) {
    let { className, showCloseButton = false, children, ...props } = param;
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
const CheckoutPageClient = ()=>{
    ...
    const handleStripeCheckout = async ()=>{
        ...
        setProcessing(true);
        try {
            var _finalOrder_items;
            let finalOrder = order;
            // If this is a temporary order (from cart), create it first
            if ((order === null || order === void 0 ? void 0 : order._id) === "temp") {
                ...
                if (!(response === null || response === void 0 ? void 0 : response.success) || !response.order) {
            ...
            const stripeItems = finalOrder === null || finalOrder === void 0 ? void 0 : (_finalOrder_items = finalOrder.items) === null || _finalOrder_items === void 0 ? void 0 : _finalOrder_items.map((item)=>({
                    name: item.name,
